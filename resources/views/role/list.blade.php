          ...
          @foreach ($data as $row)
            <tr>
              ...
              <td width="100">
                ...
                <a href="/authorization/role/delete?id={{ $row->id }}" onclick="return confirm('Are you sure want to delete this role?')" class="btn btn-danger btn-sm btn-icon"><i class="fas fa-trash"></i></a>
              </td>
            </tr>
          @endforeach
        @else
